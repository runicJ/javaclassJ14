...
gj.widget = function() {
        ...
        parseDate: function(a, b, c) {
            ...
            if (a && "string" == typeof a) {
                if (/^\d+$/.test(a)) g = new Date(a);
                    ...
                    for (f = b.split(/[\s,-\.\/\/\:]+/), e = a.split(/[\s]+/), e.length != f.length && (e = a.split(/[\s,-\.\/\/\:]+/)), d = 0; d < f.length; d++)["d", "dd"].indexOf(f[d]) > -1 ? j = parseInt(e[d], 10) : ["m", "mm"].indexOf(f[d]) > -1 ? i = parseInt(e[d], 10) - 1 : "mmm" === f[d] ? i = gj.core.messages[c || "ko-kr"].monthShortNames.indexOf(e[d]) : "mmmm" === f[d] ? i = gj.core.messages[c || "ko-kr"].monthNames.indexOf(e[d]) : ["yy", "yyyy"].indexOf(f[d]) > -1 ? (h = parseInt(e[d], 10), "yy" === f[d] && (h += 2e3)) : ["h", "hh", "H", "HH"].indexOf(f[d]) > -1 ? k = parseInt(e[d], 10) : ["M", "MM"].indexOf(f[d]) > -1 && (l = parseInt(e[d], 10));
        ...
        formatDate: function(a, b, c) {
            ...
            for (h = h.splice(1, h.length - 2), i = 0; i < g.length; i++) switch (d = h[i] || "", g[i]) {
                ...
                case "dd":
                    ...
                    break;
                case "ddd":
                    f += gj.core.messages[c || "ko-kr"].weekDaysShort[a.getDay()] + d;
                    break;
                case "dddd":
                    f += gj.core.messages[c || "ko-kr"].weekDays[a.getDay()] + d;
                    break;
                case "m":
                    f += a.getMonth() + 1 + d;
                    break;
                case "mm":
                    ...
                    break;
                case "mmm":
                    f += gj.core.messages[c || "ko-kr"].monthShortNames[a.getMonth()] + d;
                    break;
                case "mmmm":
                    f += gj.core.messages[c || "ko-kr"].monthNames[a.getMonth()] + d;
                    break;
                case "yy":
        ...
        a.fn.dialog = function(a) {
            ...
            if (this && this.length) {
                if ("object" != typeof a && a) {
                    ...
                    throw new Error("Method " + a + " does not exist.");
                }
                return new gj.dialog.widget(this, a)
            }
        }
    }(jQuery), gj.dialog.messages["ko-kr"] = {
        Close: "Close",
        DefaultTitle: "Dialog"
    }, gj.draggable = {
        plugins: {}
    ...
    }(jQuery), gj.editor.messages["ko-kr"] = {
        bold: "Bold",
        italic: "Italic",
 ...
 $(document).ready(function() {
            ...
            // 초기 날짜 설정
/*            $('#datepicker_1').datepicker('value', new Date().toISOString().split('T')[0]);
            $('#datepicker_2').datepicker('value', new Date(new Date().setDate(new Date().getDate() + 1)).toISOString().split('T')[0]);*/
            $('#datepicker_1').datepicker('value', '');
            $('#datepicker_2').datepicker('value', '');
        });