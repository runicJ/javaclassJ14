...
<head>
    ...
    <script>
	    ...
	    function fCheck() {
	    	...
	    	else let sort = sort1 + "/" + sort2 + "/" + sort3
    ...
    <div class="card mt-5 p-2">
		...
		<form name="stayInputForm" action="StayInputOk.st" method="post" enctype="multipart/form-data">
		            ...
		            <div class="form-group row">
		                ...
		                <div class="col-md-9">
		                    <div class="custom-file">
		                        <input type="file" class="fName1" id="validatedCustomFile" required>
	            ...
	            <div class="form-group row">
	                ...
	                <div class="col-md-9">
	                    <div class="custom-control custom-checkbox mr-sm-2">
	                        <input type="checkbox" name="filter" id="wifi" class="custom-control-input" id="wifi">
	                        <label class="custom-control-label" for="a/c">Wi-Fi</label>
	                    </div>
	                    <div class="custom-control custom-checkbox mr-sm-2">
	                        <input type="checkbox" name="filter" id="a/c" class="custom-control-input" id="a/c">
	                        <label class="custom-control-label" for="a/c">에어컨</label>
	                    </div>
	                    <div class="custom-control custom-checkbox mr-sm-2">
	                        <input type="checkbox" name="filter" id="parking" class="custom-control-input" id="parking">
	                        <label class="custom-control-label" for="parking">주차장</label>
	                    </div>
	                    <div class="custom-control custom-checkbox mr-sm-2">
	                        <input type="checkbox" name="filter" id="pet" class="custom-control-input" id="pet">
	                        <label class="custom-control-label" for="pet">반려동물 동반</label>
	                    </div>
	                    <div class="custom-control custom-checkbox mr-sm-2">
	                        <input type="checkbox" name="filter" id="kitchen" class="custom-control-input" id="kitchen">
	                        <label class="custom-control-label" for="kitchen">부엌</label>
	                    </div>
	                    <div class="custom-control custom-checkbox mr-sm-2">
	                        <input type="checkbox" name="filter" id="washingMachine" class="custom-control-input" id="washingMachine">
	        ...
	        <div class="text-center">
                <button type="button" class="btn btn-primary mr-2" onclick="fCheck()">등록하기</button>
